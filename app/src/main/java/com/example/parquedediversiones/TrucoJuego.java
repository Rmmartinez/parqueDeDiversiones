...
public class TrucoJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_truco_juego);
        ...
        ArrayAdapter adp = new ArrayAdapter(TrucoJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(TrucoJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TrucoJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TrucoJuego.this, Truco.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbJuegos dbjuego = new dbJuegos(TrucoJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(TrucoJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(TrucoJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(TrucoJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
