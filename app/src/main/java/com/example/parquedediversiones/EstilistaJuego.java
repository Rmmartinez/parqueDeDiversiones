...
public class EstilistaJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estilista_juego);
        ...
        ArrayAdapter adp = new ArrayAdapter(EstilistaJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(EstilistaJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        miSpinner.setAdapter(adp);
        miSpinner2.setAdapter(adp2);

        nombreJuego = "estilista";
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EstilistaJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EstilistaJuego.this, Estilista.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbJuegos dbjuego = new dbJuegos(EstilistaJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(EstilistaJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(EstilistaJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(EstilistaJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
