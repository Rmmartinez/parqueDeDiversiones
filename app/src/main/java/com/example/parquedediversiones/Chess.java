    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Chess.this, Puzzle.class);
                startActivity(intent);
            }
        });
        ...
        jugar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Chess.this, ChessJuego.class);
                startActivity(intent);
            }
        });
        ...
        estadisticas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Chess.this, ChessEstadisticas.class);
                startActivity(intent);
            }
        });
    }
    public boolean onTouchEvent(MotionEvent touchEvent) {
        switch(touchEvent.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if (x1 < x2) {
                    Intent intent = new Intent(Chess.this, Solitario.class);
                    startActivity(intent);
                } else if (x1 > x2) {
                    Intent intent = new Intent(Chess.this, Mahjong.class);
                    startActivity(intent);
                }
                break;
        }
