...
public class BasquetJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basquet_juego);
        ...
        ArrayAdapter adp = new ArrayAdapter(BasquetJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(BasquetJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(BasquetJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(BasquetJuego.this, Basquet.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbJuegos dbjuego = new dbJuegos(BasquetJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(BasquetJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(BasquetJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(BasquetJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
