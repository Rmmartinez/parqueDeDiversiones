...
public class MafiaJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mafia_juego);
        ...
        ArrayAdapter adp = new ArrayAdapter(MafiaJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(MafiaJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MafiaJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MafiaJuego.this, Mafia.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbJuegos dbjuego = new dbJuegos(MafiaJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(MafiaJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(MafiaJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(MafiaJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
