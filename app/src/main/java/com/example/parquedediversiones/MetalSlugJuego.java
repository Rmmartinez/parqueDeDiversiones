...
public class MetalSlugJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_metal_slug_juego);
        ...
        ArrayAdapter adp = new ArrayAdapter(MetalSlugJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(MetalSlugJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        miSpinner.setAdapter(adp);
        miSpinner2.setAdapter(adp2);
        nombreJuego = "metalslug";
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MetalSlugJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MetalSlugJuego.this, MetalSlug.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dbJuegos dbjuego = new dbJuegos(MetalSlugJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(MetalSlugJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(MetalSlugJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(MetalSlugJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
