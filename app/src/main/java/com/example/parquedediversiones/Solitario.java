    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Solitario.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Solitario.this, Puzzle.class);
                startActivity(intent);
            }
        });
        ...
        jugar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Solitario.this, SolitarioJuego.class);
                startActivity(intent);
            }
        });
        ...
        estadisticas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Solitario.this, SolitarioEstadisticas.class);
                startActivity(intent);
            }
        });
    }
    public boolean onTouchEvent(MotionEvent touchEvent) {
        switch(touchEvent.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if (x1 < x2) {
                    Intent intent = new Intent(Solitario.this, Truco.class);
                    startActivity(intent);
                } else if (x1 > x2) {
                    Intent intent = new Intent(Solitario.this, Chess.class);
                    startActivity(intent);
                }
                break;
        }
