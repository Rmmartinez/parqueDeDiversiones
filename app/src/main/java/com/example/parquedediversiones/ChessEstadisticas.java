...
public class ChessEstadisticas extends AppCompatActivity {
    Button back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chess_estadisticas);
        ...
        dbJuegos dbjuego = new dbJuegos(ChessEstadisticas.this);

        listaEstadisticasAdapter adapter = new listaEstadisticasAdapter(dbjuego.mostrarJugadores("chess"));
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ChessEstadisticas.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ChessEstadisticas.this, Chess.class);
                startActivity(intent);
            }
        });
    }
