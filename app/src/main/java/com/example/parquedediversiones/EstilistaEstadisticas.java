...
public class EstilistaEstadisticas extends AppCompatActivity {
    Button back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estilista_estadisticas);
        ...
        dbJuegos dbjuego = new dbJuegos(EstilistaEstadisticas.this);

        listaEstadisticasAdapter adapter = new listaEstadisticasAdapter(dbjuego.mostrarJugadores("estilista"));
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EstilistaEstadisticas.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(EstilistaEstadisticas.this, Estilista.class);
                startActivity(intent);
            }
        });
    }
