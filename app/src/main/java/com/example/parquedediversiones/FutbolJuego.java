...
public class FutbolJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_futbol_juego);
        ...
        ArrayAdapter adp = new ArrayAdapter(FutbolJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(FutbolJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(FutbolJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(FutbolJuego.this, Futbol.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbJuegos dbjuego = new dbJuegos(FutbolJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(FutbolJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(FutbolJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(FutbolJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
