...
public class TenisJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenis_juego);
        ...
        ArrayAdapter adp = new ArrayAdapter(TenisJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(TenisJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TenisJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(TenisJuego.this, Tenis.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbJuegos dbjuego = new dbJuegos(TenisJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(TenisJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(TenisJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(TenisJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
