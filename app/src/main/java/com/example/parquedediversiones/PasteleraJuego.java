...
public class PasteleraJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pastelera_juego);
        ...
        ArrayAdapter adp = new ArrayAdapter(PasteleraJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(PasteleraJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        miSpinner.setAdapter(adp);
        miSpinner2.setAdapter(adp2);
        nombreJuego = "pastelera";
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PasteleraJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PasteleraJuego.this, Pastelera.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbJuegos dbjuego = new dbJuegos(PasteleraJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(PasteleraJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(PasteleraJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(PasteleraJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
