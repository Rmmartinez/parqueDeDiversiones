...
public class SolitarioJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter adp = new ArrayAdapter(SolitarioJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(SolitarioJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        miSpinner.setAdapter(adp);
        miSpinner2.setAdapter(adp2);
        nombreJuego = "solitario";
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SolitarioJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SolitarioJuego.this, Solitario.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbJuegos dbjuego = new dbJuegos(SolitarioJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(SolitarioJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(SolitarioJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(SolitarioJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
