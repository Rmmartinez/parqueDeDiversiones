...
public class SolitarioEstadisticas extends AppCompatActivity {
    Button back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solitario_estadistica);
        ...
        dbJuegos dbjuego = new dbJuegos(SolitarioEstadisticas.this);

        listaEstadisticasAdapter adapter = new listaEstadisticasAdapter(dbjuego.mostrarJugadores("solitario"));
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SolitarioEstadisticas.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SolitarioEstadisticas.this, Solitario.class);
                startActivity(intent);
            }
        });
    }
