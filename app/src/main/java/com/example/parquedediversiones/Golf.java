    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Golf.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Golf.this, Deportes.class);
                startActivity(intent);
            }
        });
        ...
        jugar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Golf.this, GolfJuego.class);
                startActivity(intent);
            }
        });
        ...
        estadisticas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Golf.this, GolfEstadisticas.class);
                startActivity(intent);
            }
        });
    }
    public boolean onTouchEvent(MotionEvent touchEvent) {
        switch(touchEvent.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                y2 = touchEvent.getY();
                if (x1 < x2) {
                    Intent intent = new Intent(Golf.this, Futbol.class);
                    startActivity(intent);
                } else if (x1 > x2) {
                    Intent intent = new Intent(Golf.this, Tenis.class);
                    startActivity(intent);
                }
                break;
        }
