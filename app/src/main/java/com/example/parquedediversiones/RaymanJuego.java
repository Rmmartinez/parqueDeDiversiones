...
public class RaymanJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rayman_juego);
        ...
        ArrayAdapter adp = new ArrayAdapter(RaymanJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(RaymanJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(RaymanJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(RaymanJuego.this, Rayman.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dbJuegos dbjuego = new dbJuegos(RaymanJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(RaymanJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(RaymanJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(RaymanJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
