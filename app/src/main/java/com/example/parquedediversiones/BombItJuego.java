...
public class BombItJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bomb_it_juego);
        ...
        ArrayAdapter adp = new ArrayAdapter(BombItJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(BombItJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(BombItJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(BombItJuego.this, BombIt.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbJuegos dbjuego = new dbJuegos(BombItJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(BombItJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(BombItJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(BombItJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
