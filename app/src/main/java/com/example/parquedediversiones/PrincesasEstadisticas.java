...
public class PrincesasEstadisticas extends AppCompatActivity {
    Button back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_princesas_estadisticas);
        ...
        dbJuegos dbjuego = new dbJuegos(PrincesasEstadisticas.this);

        listaEstadisticasAdapter adapter = new listaEstadisticasAdapter(dbjuego.mostrarJugadores("princesas"));
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PrincesasEstadisticas.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PrincesasEstadisticas.this, Princesas.class);
                startActivity(intent);
            }
        });
    }
