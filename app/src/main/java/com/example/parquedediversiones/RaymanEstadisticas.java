...
public class RaymanEstadisticas extends AppCompatActivity {
    Button back, home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rayman_estadisticas);
        ...
        dbJuegos dbjuego = new dbJuegos(RaymanEstadisticas.this);

        listaEstadisticasAdapter adapter = new listaEstadisticasAdapter(dbjuego.mostrarJugadores("rayman"));
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(RaymanEstadisticas.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(RaymanEstadisticas.this, Rayman.class);
                startActivity(intent);
            }
        });
    }
