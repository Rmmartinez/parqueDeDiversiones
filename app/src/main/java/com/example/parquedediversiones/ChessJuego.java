...
public class ChessJuego extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chess_juego);
        ...
        ArrayAdapter adp = new ArrayAdapter(ChessJuego.this, android.R.layout.simple_spinner_dropdown_item, complejidades);
        ArrayAdapter adp2 = new ArrayAdapter(ChessJuego.this, android.R.layout.simple_spinner_dropdown_item, niveles);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ChessJuego.this, MainActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ChessJuego.this, Chess.class);
                startActivity(intent);
            }
        });
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbJuegos dbjuego = new dbJuegos(ChessJuego.this);
                ...
                if(id> 0){
                    Toast.makeText(ChessJuego.this, "REGISTRO GUARDADO", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(ChessJuego.this, Futbol.class);
                    startActivity(intent);
                }else{
                    Toast.makeText(ChessJuego.this, "ERROR AL GUARDAR REGISTRO", Toast.LENGTH_LONG).show();
